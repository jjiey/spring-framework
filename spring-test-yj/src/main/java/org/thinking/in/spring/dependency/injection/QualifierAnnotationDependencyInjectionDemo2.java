 ...
 * @see UserGroup
 */
public class QualifierAnnotationDependencyInjectionDemo2 {
	...
	public static void main(String[] args) {
		...
		QualifierAnnotationDependencyInjectionDemo2 demo = applicationContext.getBean(QualifierAnnotationDependencyInjectionDemo2.class);
