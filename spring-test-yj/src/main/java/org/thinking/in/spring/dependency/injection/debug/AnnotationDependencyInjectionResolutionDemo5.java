 ...
 * @see Qualifier
 */
public class AnnotationDependencyInjectionResolutionDemo5 {
	...
	public static void main(String[] args) {
		...
		applicationContext.register(AnnotationDependencyInjectionResolutionDemo5.class);
	...
	AnnotationDependencyInjectionResolutionDemo5 demo = applicationContext.getBean(AnnotationDependencyInjectionResolutionDemo5.class);
