 ...
 * @see Qualifier
 */
public class AnnotationDependencyInjectionResolutionDemo3 {
	...
	public static void main(String[] args) {
		...
		applicationContext.register(AnnotationDependencyInjectionResolutionDemo3.class);
	...
	AnnotationDependencyInjectionResolutionDemo3 demo = applicationContext.getBean(AnnotationDependencyInjectionResolutionDemo3.class);
