...
import org.thinking.in.spring.dependency.injection.annotation.UserGroup;
 ...
 * static
 */
public class QualifierAnnotationDependencyInjectionDemo3 {
	...
	public static void main(String[] args) {
		...
		applicationContext.register(QualifierAnnotationDependencyInjectionDemo3.class);
		...
		QualifierAnnotationDependencyInjectionDemo3 demo = applicationContext.getBean(QualifierAnnotationDependencyInjectionDemo3.class);

		// 期待输出 superUser Bean
		System.out.println("demo.user = " + demo.user);
		// 期待输出 user Bean
		System.out.println("demo.namedUser = " + demo.namedUser);
		// 期待输出 superUser user user1 user2，真实输出是 superUser user
